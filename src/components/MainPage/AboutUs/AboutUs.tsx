            ...
            <div className="aboutus__leftwrapper--descr">
              ...
              {!isTablet ? (
                ...
                <p className="aboutus__leftwrapper--textdescr">
                  ...
                  renovated and modernized to meet the expectations of <br />{" "}
        ...
        <div className="aboutus__mobilecontainer">
          ...
          <div className="aboutus__mobilewrapper">
            ...
            <p className="aboutus__leftwrapper--textdescr">
              ...
              and exceptional service. The hotel is located near the city
              center, which makes it the best option for those who travel for
