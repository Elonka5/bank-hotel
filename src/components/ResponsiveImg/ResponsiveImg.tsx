...
const imgArr = (srcImg: string,path:string) => {
  return [
    ...
    { srcSet: `${URL_TO_STORAGE}${path}%2F${srcImg}-1024.webp?alt=media`, media: '(min-width: 767.99px) and (max-width: 1439.98px)' },
    { srcSet: `${URL_TO_STORAGE}${path}%2F${srcImg}-375.webp?alt=media`, media: '(max-width: 767.98px)' }
  ];
};
